  ...
  return (
    <SafeAreaView className="flex-1 w-full justify-center items-center bg-white">
      ...
      <View className="p-6 w-full gap-2">
        ...
        <View className="w-full gap-2">
          <Text className="color-primary-text">Confirm Password</Text>
          <View className="flex-row justify-between items-center border-2 rounded-lg border-gray-300">
            <TextInput placeholder="Enter your confirm password" className="h-12" secureTextEntry={!showPassword} />
            {/* Hide show password icon */}
            <TouchableWithoutFeedback onPress={() => setShowConfirmPassword(!showConfirmPassword)}>
              <Ionicons name={showConfirmPassword ? "eye" : "eye-off"} size={24} color="#d1d5db" className="mr-2"/>
            </TouchableWithoutFeedback>
          </View>
        </View>
        ...
        <View className="flex-row justify-center items-center gap-2 mt-4">
          ...
          <Link href={{ pathname: "/auth/login" }} className="color-primary-text">
